...
<body id="index">
    ...
    <div id="cuerpo">
        <section id="Descripcion">
            <img src="img/kspLogo4.jpg" alt="">
            <p>KSP Games es una pagina donde puedes comprar videojuegos en formato fisico, asi como tambien Consolas, controles, accesorios y Ediciones de coleccion</p>
        </section>
        <br>
    </div>
    <div id="mision-vision">
        <div id="contenido">
            <article id="mision" class="">
                <div class="mision-vision_content">
                    <div >
                        <h3>Mision</h3>
                        <p class="mision-vision otroNaranjita"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut hic dignissimos totam, sunt adipisci ea vel vero cum fuga consectetur quaerat ipsa vitae nihil suscipit repudiandae, facilis libero iste. Molestias!</p>
                    </div>
                    <img src="https://cdn.icon-icons.com/icons2/1293/PNG/96/2363210-console-game-gaming-play-xbox_85516.png" alt="">
                </div>    
            </article>
            <br>
            ...
            <article id="vision">
                <div class="mision-vision_content">
                    <img src="https://cdn.icon-icons.com/icons2/1293/PNG/96/2363399-console-game-gaming-play-playstation_85478.png" alt="">
                    <div>
                        <h3>Vision</h3>
                        <p class="mision-vision otroNaranjita">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sed reiciendis nobis hic harum unde corporis at adipisci. Alias, voluptates, quod omnis earum optio voluptatibus ducimus dignissimos illo sit magni ipsa.</p>
                    </div>
                </div>
            </article>
        </div>
